...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'jim02@kh.or.kr', 'pass01', '유이', DEFAULT,
...
INSERT INTO "MEMBER"
VALUES(1, 'user01@kh.or.kr', 'pass01', '관리자', 2,
'문서/Github.jpg', DEFAULT, NULL, NULL, DEFAULT,
DEFAULT, DEFAULT);
...
DROP COLUMN IMG_ORDER;


COMMIT;

ALTER TABLE BOARD_IMG
ADD COLUMN IMG_ORDER NUMBER NULL;
