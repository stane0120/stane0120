...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user05@kh.or.kr', 'pass05!'
	, '오번유저', '01043212321', '04540,,서울시 중구 남대문로 120,,2층',
	NULL, DEFAULT, DEFAULT, DEFAULT);
...
-- user01의 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$m.TNCHzkZXudEzl/SjGwR.XpDDfv3OCCt0YIr.d86YoX5forP/jKy'
...
DELETE FROM "MEMBER" WHERE MEMBER_NO = 7;
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', '1.jpg', 0, 3498);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', '2.jpg', 0, 3482);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', '3.jpg', 0, 3481);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', '4.jpg', 0, 3475);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', '5.jpg', 0, 3472);
...
-- 마이바티스 X
-- 1~10행 조회
-- ROWNUM은 WHERE절에 사용될 떄 1행이 조건에 포함되어야 한다.
SELECT * FROM (
...
-- 게시글 좋아요 샘플데이터 삽입
INSERT INTO "BOARD_LIKE" VALUES(3498, 2);
INSERT INTO "BOARD_LIKE" VALUES(3498, 4);
COMMIT;

-- 특정 게시글의 좋아요 개수 카운트
SELECT COUNT(*) 
FROM "BOARD_LIKE" L
WHERE L.BOARD_NO = 3498;
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/1234.jpg';
...
SELECT '웹접근경로'  IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 
       ...
       1 IMG_ORDER, 3509 BOARD_NO
FROM DUAL

UNION ALL

SELECT '웹접근경로'  IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 
       2 IMG_ORDER, 3509 BOARD_NO
FROM DUAL
) A
;
...
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1번', DEFAULT, DEFAULT, 3516, 2, NULL);

INSERT INTO "COMMENT"                                    -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2번', DEFAULT, DEFAULT, 3516, 2, NULL);

-- 1001, 1002

INSERT INTO "COMMENT"                                    -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 3516, 2, 1001);

INSERT INTO "COMMENT"                                    -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 3516, 2, 1001);

INSERT INTO "COMMENT"                                    -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 3516, 2, 1001);

INSERT INTO "COMMENT"                                    -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 3516, 2, 1002);

INSERT INTO "COMMENT"                                    -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 3516, 2, 1002);

INSERT INTO "COMMENT"                                    -- 게시글, 회원
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글 2-1-1', DEFAULT, DEFAULT, 3516, 2, 1006);
