...
-- ORA-01400: NULL을 ("KH_BJH"."DEPT_COPY2"."DEPT_TITLE") 
-- 안에 삽입할 수 없습니다
...
WHERE TEST_ID = 'TEST500000'; -- 70ms

-- 인덱스 사용 O 조회
SELECT * FROM TB_INDEX_TEST
WHERE TEST_NO = 500000; -- 6ms
...
-- 인덱스 생성 후 조회
SELECT * FROM TB_INDEX_TEST
WHERE TEST_ID = 'TEST500000'; --45/2/1/2

-- 인덱스 삭제
DROP INDEX IDX_TEST_ID;

SELECT * FROM TB_INDEX_TEST
WHERE TEST_ID = 'TEST500000'; -- 22 1
