...
SELECT *
FROM EMPLOYEE e 
--WHRER SALARY < 3000000 OR SALARY > 5000000;
...
-- 사번, 이름, 부서코드 조회
SELECT EMP_ID, EMP_NAME, DEPT_XODE
FROM EMPLOYEE
WHERE DEPT_CODE = 'D5'
OR    DEPT_CODE = 'D6'
OR    DEPT_CODE = 'D9';
...
--> 문제점 : 와일드 카드 문자(_) 패턴에 사용된 일반 문자가
