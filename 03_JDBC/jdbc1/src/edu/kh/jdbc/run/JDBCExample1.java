...
public class JDBCExample1 {
    public static void main(String[] args) {
    	...
    	// -> DBeaber의 게정 접속 방법 추가와 유사함
    	
    	// 왜 Connection은 인터페이스일까??
    	// -> DBMS마다 연결 정보, 방법이 다르기 때문에
    	//    상속을 받아 공통된 부분을 각자 알맞게 구현하고
    	...
    	try {
    		...
    		// 2. DB 연결 정보를 답은 Connection 객체 생성
...
//    		System.out.println(conn);
    		...
    		while(rs.next()) {
    			...
    			// 현재 커서가 접근 행의 "EMP_NAME" 컬럼의 값을 얻어와
    			// String으로 반환
    			
    			int salary = rs.getInt("SALARY");
    			// 현재 커서가 접근 행의 "SALARY" 컬럼의 값을 얻어와
    			// int로 반환
