...
// 에러 발생
/* console.log("함수 밖에서 선언된 (전)num5 : " + num5); */
console.log("함수 밖에서 선언된 (전)num6 : " + num6);
...
function testFn2(){
    ...
    if(1==1){
        let let1 = 30;
        var let3 = 300; // let3 is nod difined
    }
...
// -> error 가 발생하지 않고 undefined로 출력됨
console.log(test);
var test = 10;
console.log(test);
...
function typeTest(){
    ...
    // Java 객체 --> class에 작성된 내용대로 
    // new 연산자 통해 메모리(heap)에 할당
    // JS의 객체 {K:V} Map형식
    ...
    box.innerHTML += "<br>sumFn : " + sumFn + " / " +user.sumFn;
