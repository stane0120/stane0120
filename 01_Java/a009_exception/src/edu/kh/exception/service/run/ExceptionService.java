package edu.kh.exception.service.run;
...
//		System.out.println(s.equals("bbb"));
	...
	public void ex2() {
		...
		// try : {} 내부에 예외가 발생할 것 같은 작성하고 실행 시도
		try {		
		System.out.print("입력 : ");
		String input = br.readLine();
		// public String readLine()  throws IOException
		// -> IOException 이라는 Checked Exception을 발생 시키는 메서드
        //  -> Exception이 발생할 경우에 대비해서 예외처리 구문 작성
	...
	public void ex3() {
		...
		//catch(Exception e) {}
			...
			//            하위 타입 catch에 대한 검사가 먼저 진행되기 한다
